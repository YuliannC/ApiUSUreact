...
namespace Usuario_API.Controllers
{
    ...
    [ApiController]
    public class t_tipodocumentosController : ControllerBase
    {
        private readonly usuarioDbContext _context;

        public t_tipodocumentosController(usuarioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<t_tipodocumento>> Postt_tipodocumento(t_tipodocumento t_tipodocumento)
        {
          if (_context.t_tipodocumento == null)
          {
              return Problem("Entity set 'usuarioDbContext.t_tipodocumento'  is null.");
          }
